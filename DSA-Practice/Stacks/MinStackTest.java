...
class MinStack {
    ...
    public void pop() {
        ...
        System.out.println("pop " + mainstack.peek());
    }
...
// Approach
// Key Idea:
// To ensure that getMin works in constant time, we use a second stack
// (minStack) to keep track of the minimum element at each step.
...
// For minStack, push the element if it is smaller or equal to the current
// minimum.
